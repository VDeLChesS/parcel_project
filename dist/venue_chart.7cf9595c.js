...
},{"../dist/chart.js":"../node_modules/chart.js/dist/chart.js"}],"Charts/venue_chart.js":[function(require,module,exports) {
"use strict";

var _exhibition_data = _interopRequireDefault(require("../data/exhibition_data.js"));
...
_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  var data, getTopVenuesByNbOfArtists, getTopVenuesByPaintings, getTopVenuesByNbOfExhibitions, createChartData;
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        data = _exhibition_data.default; // Function to get the top 10 venues by number of artists
        getTopVenuesByNbOfArtists = function getTopVenuesByNbOfArtists() {
        ...
        getTopVenuesByPaintings = function getTopVenuesByPaintings() {
          return Object.values(data.reduce(function (acc, curr) {
            if (!acc[curr.e_venue]) {
              acc[curr.e_venue] = {
                e_venue: curr.e_venue,
        ...
        getTopVenuesByNbOfExhibitions = function getTopVenuesByNbOfExhibitions() {
          return Object.values(data.reduce(function (acc, curr) {
            if (!acc[curr.e_venue]) {
              acc[curr.e_venue] = {
                e_venue: curr.e_venue,
        ...
        createChartData = function createChartData(chartType) {
          ...
          return {
            labels: topVenues.map(function (venue) {
              return venue.e_venue;
            }),
            datasets: [{
              label: "Top 10 Venues by ".concat(label),
              data: topVenues.map(function (venue) {
                return venue[dataKey];
              }),
        ...
        window.updateVenueChart = function (chartType) {
          ...
          var ctx = document.getElementById("venueChart");
          currentVenueChart = new _auto.default(ctx, {
            type: "bar",
...
},{"../data/exhibition_data.js":"data/exhibition_data.js","chart.js/auto":"../node_modules/chart.js/auto/auto.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","Charts/venue_chart.js"], null)
//# sourceMappingURL=/venue_chart.7cf9595c.js.map